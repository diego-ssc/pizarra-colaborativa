          ...
          <ul>
            <li class="mb-2">
              <a href="#" class="flex items-center text-white hover:text-gray-10 hover:bg-gray-100 p-2 rounded">
                ...
                <span class="block text-sm">All boards</span>
              </a>
            </li>
            <li class="mb-2">
              <a href="#" class="flex items-center text-white hover:text-gray-10 hover:bg-gray-100 p-2 rounded">
                ...
                <span class="text-sm">Recent boards</span>
              </a>
            </li>
            <li class="mb-2">
              <a href="#" class="flex items-center text-white hover:text-gray-10 hover:bg-gray-100 p-2 rounded">
                ...
                <span class="block text-sm">Starred boards</span>
              </a>
            </li>
            <li class="mb-2">
              <a href="#" class="flex items-center text-white hover:text-gray-10 hover:bg-gray-100 p-2 rounded">
                ...
                <span class="block text-sm">Shared with you</span>
              </a>
            </li>
          </ul>
        </div>
